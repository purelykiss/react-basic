...
app.use(cors( //도메인 대신에 * 로 하면 모든 도메인에서 허용된다. 보안상 도메인을 지정하는것이 안전하다.
    {
        origin: "*",    //origin: ["http://localhost:3000"/*, "다른url"*/],
        methods: ["GET", "POST"]
    }
));
...
app.use('/openapi/getdata', function (req, res) { //이벤트 발생 시 자동 실행되는 함수인 콜백 함수가 실행된다.
    ...
    var queryParams = '?' + encodeURIComponent('serviceKey') + '=o5VVuFuWRkpRkfc5MbQDZ1ZC4CKBkW96WXE962lMDqUIwRX20KN%2FHNlOV2aX3quc0Zn4ZkkQQpfLnSTtQEX4SA%3D%3D'; /* Service Key*/
